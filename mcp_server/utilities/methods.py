...
async def ping() -> MethodResult:
    return {}, {}


async def cancelled_notification(
    request_id: str | NumberType, reason: str | None = None
) -> MethodResult:
    return None, {}


async def long_running() -> MethodResult:
    ...
    for i in range(10):
        ...
        await progress_notification(
            progress=(i + 1) * 10, total=100, message=f"partial result = {result}"
        )
